...
### Antibiotic Regulatory approval {.unnumbered}
...
As a result, the cost of antibiotic development has become unsustainable. A 2017 estimate puts the cost of developing an antibiotic at around US\$1.5 billion. Meanwhile, industry analysts estimate that the average revenue generated from an antibiotic's sale is roughly \$46 million per year.\[@WoutersEtAl2020\] Therefore it is not surprising that antibiotic research and development has been largely abandoned by large pharmaceutical companies given the high risk and poor financial incentives.
