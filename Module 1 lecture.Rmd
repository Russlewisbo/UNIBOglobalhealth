...
institute: "Department of Medical and Surgical Sciences"
date: "2022/1/12 (updated: `r Sys.Date()`)"
output:
...
style_mono_light(
  ...
  text_font_google   = google_font("Loto sans", "300", "300i"),
...
## 97039-Global Heath, Antimicrobial Drugs and Vaccines
### Global Aspects of Antimicrobial Resistance
<br>
<br>
**Prof. Russell E. Lewis / Infectious Diseases** <br>
...
- #### Review the history and current factors driving antimicrobial resistance worldwide

- #### Discuss elements of the *One Health* approach to addressing antimicrobial resistance

- #### Explore challenges of managing antimicrobial resistance in high-income (HIC) vs. low and middle-income countries (LMICs)

- #### Examine lessons learned from the COVID-19 pandemic that can be applied to managing cross-boarder transmission of antimicrobial resistance
...
## Trends in life expectancy over 500 years

<iframe src="https://ourworldindata.org/grapher/life-expectancy?tab=chart" loading="lazy" style="width: 90%; height: 500px; border: 50px none;">

---

# Antibiotic use in livestock

<iframe src="https://ourworldindata.org/grapher/antibiotic-use-in-livestock?country=USA~CHN" loading="lazy" style="width: 100%; height: 500px; border: 50px none;">
