...
**Figure 5. Prevalence of third-generation cephalosporin-resistant (3GCR) Klebsiella spp. by gross national income per capita and predicted values with 95% confidence intervals according to a linear regression model.** Data are from reference. [@Alvarez-UriaEtAl2016].
...
**Figure 15. Hotspots of antimicrobial resistance.**
