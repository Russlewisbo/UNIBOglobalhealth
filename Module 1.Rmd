...
**Figure X. Global antibiotic use and resistance by income class.** (A) High-income countries (HICs); and (B) Low-Middle Income Countries (LMICs). [@CenterforDiseaseDynamicsEconomicsandPolicy2021]
